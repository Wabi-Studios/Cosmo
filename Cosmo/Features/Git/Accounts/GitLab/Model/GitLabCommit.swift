...
extension GitLabAccount
{
  ...
  {
    let router = GitLabCommitRouter.readCommit(configuration, id: id, sha: sha)
  ...
  {
    let router = GitLabCommitRouter.readCommitDiffs(configuration, id: id, sha: sha)
  ...
  {
    let router = GitLabCommitRouter.readCommitComments(configuration, id: id, sha: sha)
