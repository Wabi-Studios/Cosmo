  ...
  private var basicInformation: some View
  {
    VStack(alignment: .leading)
    {
      ...
      VStack(alignment: .leading)
      {
        ...
        Text("Example: Cosmo crashes when using autocomplete")
          .font(.system(size: 10))
    ...
    VStack(alignment: .leading)
    {
      ...
      VStack(alignment: .leading)
      {
        ...
        TextEditor(text: $feedbackModel.issueDescription)
          ...
          .border(Color(NSColor.separatorColor))
        Text("Example: Cosmo crashes when the autocomplete popup appears on screen.")
          .font(.system(size: 10))
          .foregroundColor(.secondary)
      }
      .padding(.top, -5)
      ...
      VStack(alignment: .leading)
      {
        ...
        Text("Example: The autocomplete window flickered on screen and Cosmo crashed. See attached crashlog.")
          .font(.system(size: 10))
          .foregroundColor(.secondary)
      }
      .padding(.top)
