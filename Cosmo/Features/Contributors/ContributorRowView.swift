...
struct ContributorRowView: View
{
  ...
  {
    AsyncImage(url: contributor.avatarURL)
    { image in
      image
        .resizable()
...
struct ContributorRowView_Previews: PreviewProvider
{
  static var previews: some View
  {
    let contributor = Contributor(
      login: "Wabi-Studios",
      name: "Wabi Studios",
      avatarURLString: "https://avatars.githubusercontent.com/u/45982888?s=200&v=4",
      profile: "https://wabi.foundation",
      contributions: [.studio, .multiverse, .code]
    )
