...
final class ThemeModel: ObservableObject
{
  ...
  /// The base folder url `~/Library/Application Support/Cosmo/`
  private var baseURL: URL
  {
    filemanager.homeDirectoryForCurrentUser.appendingPathComponent("Library/Application Support/Cosmo")
  }
  ...
  /// Loads all available themes from `~/Library/Application Support/Cosmo/themes/`
  ///
  /// If no themes are available, it will create a default theme and save
  /// it to the location mentioned above.
  ///
  /// When overrides are found in `~/Library/Application Support/Cosmo/.settings.json`
  /// they are applied to the loaded themes without altering the original
  /// the files in `~/Library/Application Support/Cosmo/themes/`.
  ...
  private func loadBundledThemes() throws
  {
    let bundledThemeNames: [String] = [
      ...
      "cosmo-github-light",
      "cosmo-midnight",
      "cosmo-solarized-dark",
      "cosmo-solarized-light",
    ]
  ...
  /// from `~/Library/Application Support/Cosmo/themes`. See ``loadThemes()``
  ...
  /// Removes the given theme from `–/Library/Application Support/Cosmo/themes`
  ///
  ...
  /// in `~/Library/Application Support/Cosmo/settings.json`.
  private func saveThemes()
  {
    ...
    { theme in
      do
      {
        // load the original theme from `~/Library/Application Support/Cosmo/themes/`
